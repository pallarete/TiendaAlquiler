    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1984, 4, 1, 8, null, false, "Ferrari", "F40", 2, 1500m },
                    { 2, 1963, 6, 3, 6, null, false, "Aston Martin", "DB5", 4, 3000m },
                    { 3, 1970, 6, 6, 7, null, false, "Porsche", "911", 5, 2000m },
                    { 4, 1955, 4, 1, 5, null, false, "Ferrari", "250 GTO", 2, 300m },
                    { 5, 1958, 3, 2, 5, null, false, "Jaguar", "E-Type", 4, 250m },
                    { 6, 1980, 3, 3, 8, null, false, "Rolls Royce", "Silver Cloud", 3, 400m },
                    { 7, 1999, 5, 4, 9, null, false, "Subaru", "Impreza WRX", 7, 120m },
                    { 8, 1955, 2, 5, 5, null, false, "Mercedes-Benz", "300 SL", 5, 350m },
                    { 9, 1966, 7, 8, 6, null, false, "Austin", "Mini Cooper", 4, 100m },
                    { 10, 1967, 6, 1, 6, null, false, "Ford", "Mustang", 6, 500m },
                    { 11, 1969, 6, 2, 6, null, false, "Chevrolet", "Camaro", 6, 450m },
                    { 12, 1950, 7, 8, 5, null, false, "Volkswagen", "Beetle", 5, 100m },
                    { 13, 1975, 4, 5, 7, null, false, "Alfa Romeo", "Giulia", 2, 200m },
                    { 14, 1992, 5, 4, 9, null, false, "Mazda", "RX-7", 7, 300m },
                    { 15, 1972, 6, 6, 7, null, false, "BMW", "2002", 5, 220m },
                    { 16, 1957, 7, 7, 5, null, false, "Citroën", "2CV", 3, 120m },
                    { 17, 1973, 6, 1, 7, null, false, "Lancia", "Stratos", 2, 600m },
                    { 18, 1968, 7, 2, 6, null, false, "Fiat", "500", 2, 150m },
                    { 19, 1981, 6, 3, 8, null, false, "DeLorean", "DMC-12", 6, 800m },
                    { 20, 1994, 6, 4, 9, null, false, "Toyota", "Supra", 7, 400m },
                    { 21, 1988, 5, 6, 8, null, false, "Peugeot", "205 GTI", 3, 180m },
                    { 22, 1965, 6, 5, 6, null, false, "Renault", "Alpine A110", 3, 300m },
                    { 23, 1932, 6, 3, 3, null, false, "Bugatti", "Type 35", 3, 1000m },
                    { 24, 1969, 6, 1, 6, null, false, "Lamborghini", "Miura", 2, 2000m },
                    { 25, 1998, 5, 4, 9, null, false, "Mitsubishi", "Lancer Evolution VI", 7, 250m },
                    { 26, 1995, 5, 5, 9, null, false, "Nissan", "Skyline GT-R", 7, 450m },
                    { 27, 1959, 3, 7, 5, null, false, "Cadillac", "Eldorado", 6, 600m },
                    { 28, 1961, 6, 3, 6, null, false, "Volvo", "P1800", 8, 200m },
                    { 29, 1991, 6, 1, 9, null, false, "Honda", "NSX", 7, 350m }
                });
